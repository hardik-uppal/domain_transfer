...
#        if load_weight_epoch is not None:
        ...
        generator_model.load_weights('D:/tutorial/hulk_dump/gen_weights_epoch200.h5')
...
#                rgb_train_dir = 'D:/RGB_D_Dataset_new-iiitd/fold1/train/RGB'
                rgb_train_dir = 'D:/EURECOM_Kinect_Face_Dataset_crop/RGB'
#                rgb_val_dir = 'D:/RGB_D_Dataset_new-iiitd/fold1/test/RGB'
                rgb_val_dir = 'D:/EURECOM_Kinect_Face_Dataset_crop/RGB'
...
#                    print('batch_counter:{}'.format(batch_counter))
                    if batch_counter_val >= int(936 / int(batch_size)):
                        break
                
                print_val_loss = val_loss/int(936 / int(batch_size))
                print_val_acc1 = val_acc1/int(936 / int(batch_size))
                print_val_acc2 = val_acc2/int(936 / int(batch_size))
                print_val_acc3 = val_acc3/int(936 / int(batch_size))
