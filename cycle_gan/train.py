...
#args.dataset = 'rgb'
# output_dir
output_dir = py.join('output1', args.dataset)
py.mkdir(output_dir)
...
A_img_paths, A_img_paths_test = data.path_extarct(rgb_image_dir, args.dataset, 'yes')


depth_image_dir = [py.join(args.datasets_dir, 'depth','train'),py.join(args.datasets_dir, 'depth','test')]
B_img_paths, B_img_paths_test = data.path_extarct(depth_image_dir, args.dataset, 'yes')
